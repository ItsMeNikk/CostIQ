/** Shared homepage / marketing strings — keep pricing and CTAs in sync here. */

export const STARTER_SPEND_LIMIT = "up to $500/mo in AI spend";

export const STARTER_FOOTNOTE =
  `Starter is free for teams with ${STARTER_SPEND_LIMIT}. No credit card required.`;

export const HERO_TRUST_LINE =
  `No credit card required · 2-minute setup · Free for teams with ${STARTER_SPEND_LIMIT}`;
