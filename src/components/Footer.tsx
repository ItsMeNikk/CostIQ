      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <a
              href="https://github.com/ItsMeNikk/CostIQ"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="GitHub"
              className="w-9 h-9 rounded-lg bg-white/8 border border-white/12 flex items-center justify-center text-white/50 hover:text-[#48cae4] hover:border-[#48cae4]/30 hover:bg-white/12 transition-colors duration-200"
            >
