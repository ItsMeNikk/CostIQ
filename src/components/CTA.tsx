...
export default function CTA() {
  ...
  return (
    <section id="cta" className="py-20 sm:py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="absolute top-[-20%] left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-[#4A70B0]/10 rounded-[0_0_60%_60%]" />
      ...
      <div ref={ref} className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
        ...
        <motion.p
          ...
          className="text-[14px] sm:text-[15px] md:text-[16px] text-[#04080F]/60 mb-8 sm:mb-10 md:mb-12 max-w-xl mx-auto font-light"
        >
          Join 2,400+ teams who trust CostIQ to find the hidden costs in their AI stack. Free to start. No credit card needed.
        </motion.p>
        ...
        >
          Free forever for teams under $500/mo AI spend.{" "}
          <span className="text-[#4A70B0] font-semibold">No credit card required.</span>
        </motion.p>
        ...
        >
          {["SOC 2 Type II", "GDPR Compliant", "256-bit AES"].map((badge) => (
