...
const features = [
  {
    ...
    description: "Add every AI tool your team uses — we benchmark your current plans against alternatives to find where you're paying too much for what you're getting.",
  ...
  },
  {
    ...
    description: "See exactly how much you can save per tool, per month, and per year — with specific actions ranked by impact. No vague suggestions.",
  ...
  },
  {
    ...
    description: "Understand if you're on the right plan tier. We identify when you'd save by switching tiers, enabling team plans, or moving to annual billing.",
  ...
  },
  {
    ...
    description: "Understand which parts of your team are driving AI spend. Attribute costs by tool, by seat, and by function — useful for budget conversations.",
  ...
  },
  {
    ...
    description: "Export a clean, branded PDF or share a link. Perfect for handing off to your finance team, bringing to leadership, or including in a board deck.",
  ...
  },
  {
    ...
    description: "Every audit includes a plain-English summary explaining the biggest opportunities in context of your team size and use case — not just numbers.",
    badge: "Plain-English",
  },
];
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
          {features.map((feature, i) => (
            ...
            >
              ...
              <p className="text-[13px] sm:text-[14px] text-[#04080F]/55 leading-relaxed font-light">{feature.description}</p>
